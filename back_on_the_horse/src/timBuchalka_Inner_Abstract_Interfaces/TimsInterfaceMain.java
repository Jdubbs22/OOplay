...
public class TimsInterfaceMain {
	...
	public static void main(String[] args) {
        ...
        saveObject(tim);
    //   loadObject(tim);  this one uses the scanner to fill the array
        System.out.println(tim);

        ISaveable2 werewolf = new Monster("Werewolf", 20, 40);
	 ...
	 public static ArrayList<String> readValues() {
	    ...
	    public static void saveObject(ISaveable2 objectToSave) {
	        for(int i=0; i<objectToSave.write().size(); i++) {
	            System.out.println("Saving " + objectToSave.write().get(i) + " to storage device");
	        }//end for
	    }//end method

	    public static void loadObject(ISaveable2 objectToLoad) {
